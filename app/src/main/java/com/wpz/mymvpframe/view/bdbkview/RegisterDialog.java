...
public class RegisterDialog extends Dialog {
    ...
    public RegisterDialog(@NonNull Context context, @StyleRes int themeResId) {
...
//            ((TextView) layout.findViewById(R.id.title)).setText(title);
            // set the confirm button
                ImageView register_close = (ImageView) layout.findViewById(R.id.register_close);
            ...
            ImageView register_go = (ImageView) layout.findViewById(R.id.register_go);
