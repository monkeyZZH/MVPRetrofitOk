...
public class ArticleDetailsCourseListAdapter extends BaseAdapter {
    private Context context;
    private List<CourseDetailsBean.DataBean.CommentsBean> mData;

    public ArticleDetailsCourseListAdapter(Context context, List<CourseDetailsBean.DataBean.CommentsBean> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ArticleDetailsCourseListAdapter.ViewHolder holder;
        if (convertView == null) {
            convertView = convertView.inflate(context, R.layout.item_course_comment_list, null);
            holder = new ArticleDetailsCourseListAdapter.ViewHolder();
            ...
            holder = (ArticleDetailsCourseListAdapter.ViewHolder) convertView.getTag();//取出ViewHolder对象
        }
