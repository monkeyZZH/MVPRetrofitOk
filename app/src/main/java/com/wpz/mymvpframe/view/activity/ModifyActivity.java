...
import com.wpz.mymvpframe.presenter.ModifyPresenter;
import com.wpz.mymvpframe.view.iview.IModifyView;
...
public class ModifyActivity extends BaseActivity<ModifyPresenter> implements IModifyView,View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        umobie = bundle.getString("umobile");
        Province = bundle.getString("province");
        City = bundle.getString("city");
        County = bundle.getString("county");
        detail = bundle.getString("detail");
        is_default = bundle.getInt("is_default");
        addaddress_name_edit.setText(uname);
        addaddress_phone_edit.setText(umobie);
        addaddress_address_text.setText(Province + City +County);
        addaddress_address_edit.setText(detail);
        if (is_default == 1){
            addaddress_default_btn.setOpened(true);
        }else {
            addaddress_default_btn.setOpened(false);
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){case R.id.title_left_return:
            finish();
            break;
            ...
            case R.id.addaddress_save_btn:
                ...
                mPresenter.getModifyData(this, ItemId, name, phone, Province, City, County, address, a);
                finish();
                break;
    ...
    private void selectAddress() {
        CityPicker cityPicker = new CityPicker.Builder(ModifyActivity.this)
                .textSize(14)
